...
export const CREDENTIALS: Record<string, UserCredential> = {
  student: { role: "student", password: "student", name: "Sai Kiran", sub: "CSE – 3rd Year", avatar: "SK", color: "#4f46e5", email: "student@university.edu" },
  hod:     { role: "hod",     password: "hod12345",     name: "Dr. S. Ramesh",  sub: "HOD – CSE Dept.",    avatar: "SR", color: "#0891b2", email: "hod@university.edu" },
  faculty: { role: "faculty", password: "faculty",       name: "Dr. Priya K.",   sub: "Associate Professor", avatar: "PK", color: "#7c3aed", email: "faculty@university.edu" },
  admin:   { role: "admin",   password: "admin12345",   name: "Admin",          sub: "Platform Admin",      avatar: "AD", color: "#dc2626", email: "admin@university.edu" },
};
